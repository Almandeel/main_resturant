...
class ItemController extends Controller
{
    ...
    */
    public function store(Request $request)
    {
        ...
        if($request->barcode) {
            ...
            $last_barcode = Item::latest()->first() ? Item::latest()->first()->barcode : null;
    ...
    */
    ...
    public function updateUnit(Request $request, Item $item){
        $item_store_unit_id = ItemStoreUnit::where('item_unit_id', function($q) use($request, $item) {
